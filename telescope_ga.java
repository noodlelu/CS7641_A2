...
public class telescope_ga {
    private static Instance[] instances = initializeInstances();
    private static Instance[] train_set = Arrays.copyOfRange(instances, 0, 15216);
    private static Instance[] test_set = Arrays.copyOfRange(instances, 15216, 19020);
    ...
    public static void main(String[] args) {
        ...
        for (int trainingIterations : iterations) {
            ...
            for (int q = 0; q < population.length; q++) {
                ...
                write_output_to_file("Optimization_Results", "telescope_results_ga.csv", final_result, true);
    ...
    private static Instance[] initializeInstances() {
        ...
        try {
            BufferedReader br = new BufferedReader(new FileReader(new File("src/opt/mlu324/telescope.csv")));
